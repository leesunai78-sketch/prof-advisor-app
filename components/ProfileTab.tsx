...
const FIELDS: { key: keyof ProfessorProfile; label: string; placeholder: string; hint: string }[] = [
  { key: "name", label: "그녀의 이름", placeholder: "예: 김OO", hint: "" },
  { key: "field", label: "전공 분야", placeholder: "예: 경영학 / 사회복지학 / 교육학", hint: "" },
  { key: "commStyle", label: "커뮤니케이션 스타일", placeholder: "예: 말이 짧고 직접적 / 돌려서 말하는 편 / 감정 표현이 거의 없음", hint: "그녀의 스타일" },
  ...
  { key: "complaintStyle", label: "불만 표현 방식", placeholder: "예: 말이 짧아짐 / 답장 지연 / '다시 생각해봐'라고 하심", hint: "그녀가 불만족스러울 때 어떤 신호를 보이는지" },
  { key: "requestVsOrder", label: "요청 vs 지시 구분", placeholder: "예: '한번 봐봐' = 반드시 해야 함 / '생각해봐' = 선택", hint: "그녀의 표현이 부탁인지 명령인지 헷갈릴 때 참고" },
